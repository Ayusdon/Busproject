...
var busMarker1 = L.marker(path1Coordinates[0], { icon: busIcon }).addTo(map);
var busMarker2 = L.marker(path1Coordinates[0], { icon: busIcon }).addTo(map);


// Function to animate the marker along the path
var currentIndex = 0;
var totalPoints = path1Coordinates.length;
...
var currentIndex1 = 0;
        ...
        // Move both bus markers every 1 second
